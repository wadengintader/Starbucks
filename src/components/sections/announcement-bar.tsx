...
const AnnouncementBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-[#006241] border-b border-[#9C1C26]/30 py-1.5 px-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-2 text-center">
              <Clock 
                className="w-3.5 h-3.5 text-white animate-pulse shrink-0" 
                strokeWidth={2.5}
              />
              <p className="text-white text-[12px] font-bold tracking-tight text-center">
                You have{" "}
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          <p className="text-white/60 text-[9px] uppercase tracking-[0.15em] font-bold">
      ...
      <div className="absolute bottom-0 left-0 h-[2px] bg-gradient-to-r from-transparent via-[#9C1C26] to-transparent w-full opacity-50 overflow-hidden">
